// Product Data
const products = [
    { id: 1, name: 'Merkurius', flavor: 'Oreo', price: 25000 },
    { id: 2, name: 'Venus', flavor: 'Vanila', price: 25000 },
    { id: 3, name: 'Bumi', flavor: 'Matcha', price: 25000 },
    { id: 4, name: 'Mars', flavor: 'Stroberi', price: 25000 },
    { id: 5, name: 'Jupiter', flavor: 'Peanut Butter', price: 25000 },
    { id: 6, name: 'Saturnus', flavor: 'Keju', price: 25000 },
    { id: 7, name: 'Uranus', flavor: 'Mint', price: 25000 },
    { id: 8, name: 'Neptunus', flavor: 'Bluberry', price: 25000 }
];
...
function processOrder() {
    ...
    if (delivery === 'delivery' && !address) {
        alert('Silakan isi alamat untuk pengiriman!');
        return;
    }
    ...
    orderDetails += `\nTotal: Rp ${total.toLocaleString('id-ID')}\nMetode Pembayaran: ${payment.value === 'qris' ? 'QRIS' : 'Tunai'}\nMetode Pengiriman: ${delivery === 'pickup' ? 'Ambil Langsung' : 'Delivery'}\nAlamat: ${address || 'Ambil langsung'}`;
